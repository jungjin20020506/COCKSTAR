...
const PAGES = [
    ...
    {
        kicker: '새로 생긴 기능',
        title: '이번 업데이트로 생긴 것들',
        items: [
            { h: '📢 공지사항', p: '<b>설정 맨 위</b>에서 등록해요. 방 상단에 고정되고, 새로 입장하는 사람은 <b>입장 화면에서도</b> 봅니다. 바꾸는 순간 접속자 전원에게 실시간으로 반영돼요.' },
            { h: '🕐 매칭 타임라인', p: '“경기 진행” 탭 맨 아래에서 <b>오늘 끝난 경기 전부</b>를 시간순으로 봅니다.\n“아까 그 경기 누구랑 누구였지?”가 사라져요.' },
            { h: '🎨 방 포인트 색', p: '방 정보 수정에서 색을 고르면 헤더·탭·코트가 그 색으로 물들어요. 로비 카드에서도 보입니다.' },
            { h: '↔️ 스와이프 · PC 2열', p: '화면을 좌우로 쓸면 <b>매칭 ↔ 경기</b> 탭이 넘어가요.\nPC 로 열면 두 화면이 나란히 펼쳐집니다.' },
            { h: '🔁 3연속 방지', p: '쉼 없이 <b>3경기 연속</b>이 되는 선수는 자동매칭이 알아서 피해요. 후보 카드의 사유에도 표시됩니다.' },
        ],
    },
];
